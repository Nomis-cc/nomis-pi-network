// ------------------------------------------------------------------------------------------------------
// <copyright file="IStatsCalculator.cs" company="Nomis">
...
namespace Nomis.Blockchain.Abstractions.Calculators
{
    ...
    public interface IStatsCalculator
    {
            ...
            IEnumerable<(string Hash, BigInteger Amount)> internalTransactionsDatas)
        {
            ...
            foreach (var data in internalTransactionsDatas.Where(x => x.Hash != null && transactions.Contains(x.Hash.ToLowerInvariant())))
            {
                result += data.Amount;
            }
    ...
    /// Blockchain wallet stats calculator.
    /// </summary>
    public interface IStatsCalculator<TTransactionIntervalData> :
        IStatsCalculator
    ...
    /// Blockchain wallet stats calculator.
    /// </summary>
    public interface IStatsCalculator<out TWalletStats, TTransactionIntervalData> :
        IStatsCalculator<TTransactionIntervalData>
